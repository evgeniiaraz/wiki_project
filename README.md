...
The model contains 5 files:
 - docvecs.txt.doctag_syn0 - stores the tags for documents(in my case - they are titles of the Wiki articles)
 ...
 - wiki-en_pvdbow.doc2vec_model.wv.syn0.npy - if I inderstand it correctly(and I am not 100% sure), the syn0 and syn1 are the 'weights' for neural net in doc2vec model. 
