...
if __name__ == '__main__':
    ...
    id2word = gensim.corpora.Dictionary.load_from_text(bz2.BZ2File('data/wiki-en_wordids.txt.bz2'))

    # build tfidf, ~50min
    mm = gensim.corpora.MmCorpus(bz2.BZ2File('data/wiki-en_tfidf.mm.bz2'))

    gensim.models.ldamodel.LdaModel(corpus=mm, id2word=id2word, num_topics=300, update_every=1, chunksize=10000, passes=1)

    hdp.save('data/wiki-en.lda_model')
